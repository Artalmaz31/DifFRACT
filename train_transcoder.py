"""Train timestep-conditioned transcoders for FLUX.1[schnell] MLP sublayers."""
...
def main():
    ...
    p.add_argument(
        ...
        nargs="+",
        default=[6, 12, 18],
        help="Double-stream block indices to train (both img and txt streams)",
    )
    p.add_argument(
        "--dataset-id",
        default=TrainConfig.dataset_id,
        help="HuggingFace prompt corpus id",
    )
    p.add_argument("--save-dir", default="./output", help="Where to write checkpoints")
    ...
    run_training(cfg, role="transcoder")
